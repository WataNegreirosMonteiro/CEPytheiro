export default function DecorativeLine({ type }) {
    return (
        <div className={`hidden md:block absolute ${type === 'left' ? 'bottom-0 start-0 translate-y-10 -translate-x-32' : 'top-0 end-0 -translate-y-12 translate-x-20'}`}>
            {type === 'left' ? (
